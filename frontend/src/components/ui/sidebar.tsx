      ...
      >
        ...
        <div
          className={cn(
            ...
            side === "left" && "left-0",
            side === "right" && "right-0",
            collapsible === "offcanvas" && state === "collapsed" && side === "left" && "left-[calc(var(--sidebar-width)*-1)]",
            collapsible === "offcanvas" && state === "collapsed" && side === "right" && "right-[calc(var(--sidebar-width)*-1)]",
            // Borders
            side === "left" && "border-r",
            side === "right" && "border-l",
            className
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant: (variant ?? "default") as any, size: (size ?? "default") as any }), className ?? undefined)}
        {...props}
      />
    )
